    ...
    "scrollX": true,
      ...
      "columns": [
        ...
        'mRender': function (datos) {
          return '<a href="bitacoraHost/'+datos.id+'" class="btn btn-xs btn-default mr-1"><i class="fa fa-eye"></i></a>'+
          '@can('create bitacorasHost')<a href="bitacoraHost/'+datos.id+'/edit" class="btn btn-xs btn-info mr-1"><i class="fas fa-pencil-alt"></i></a>@endcan' +
          '@can('create bitacorasHost')<form method="post" action="bitacoraHost/'+datos.id+'" style="display: inline;">'+
          '@method('delete')'+
          '@csrf'+
